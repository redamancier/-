...
void inf_Uart4_deal_irq_dma_tx(void) { _Uart4_deal_irq_dma_tx(); }

uint8_t inf_Uart4_deal_irq_tx_end(void) { return _Uart4_deal_irq_tx_end(); }

uint8_t inf_Uart4_deal_irq_rx_end(uint8_t *buf) {
    return _Uart4_deal_irq_rx_end(buf);
}

void Uart4_dma_tx_irq_handler(void) { inf_Uart4_deal_irq_dma_tx(); }
