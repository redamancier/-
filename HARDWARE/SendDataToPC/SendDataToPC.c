...
//	DataToSend[cnt++]=8;
//	
//	DataToSend[cnt++]=BYTE0(err);
//	DataToSend[cnt++]=BYTE1(err);
//	DataToSend[cnt++]=BYTE2(err);
//	DataToSend[cnt++]=BYTE3(err);
//	
...
//	DataToSend[cnt++] = 0xff;
//	DataToSend[cnt++] = 0xf0;
//	DataToSend[cnt++]=Car_Status.Car_StatusEvent;
//	DataToSend[cnt++]=Car_Status.move_speed;
//	DataToSend[cnt++]=Car_Status.turn_speed;
//	DataToSend[cnt++] = 0xfe;
//	
//	Usart_PC_SendArray(USART1,DataToSend,cnt);
//}
